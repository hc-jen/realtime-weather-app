...
export default function WeatherSetting({ cityName, handleCurrentPageChange, handleCurrentCityChange }) {
  const [locationName, setLocationName] = React.useState(cityName);
